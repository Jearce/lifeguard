...
class Checklist(models.Model):
    ...
    social_security_card = models.FileField(null=True)
    social_security_number = models.CharField(null=True,max_length=10)
    birth_certificate = models.FileField(blank=True,null=True)
    w4 = models.FileField(null=True)
    i9 = models.FileField(null=True)
    workers_comp = models.FileField(null=True)
    ...
    banking_name = models.CharField(null=True,max_length=255)
    account_type = models.CharField(choices=ACCOUNT_TYPES,max_length=1,null=True,default=None)
    account_number = models.CharField(null=True,max_length=255)
    savings_number = models.CharField(null=True,max_length=255)
    email_address = models.EmailField(null=True,max_length=255)
